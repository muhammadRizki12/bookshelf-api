...
const getAllBooksHandler = (request, h) => {
  ...
  // Filtered byName
  if (name) {
    const filteredName = newBook.filter((b) => {
  ...
  // Filtered by finished status
  if (finished === '1') {
    const filteredIsFinished = books
